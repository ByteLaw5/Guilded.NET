...
namespace Guilded.NET.Objects.Teams {
    ...
    public class GCategory: GBaseObject<GCategory>, ITeamChannel {
        ...
        public override bool Equals(object obj) {
            if(obj is GCategory ca) return ca.TeamId == TeamId && ca.Id == Id;
            else return false;
        }
        /// <summary>
        ...
        /// <returns>If it's equal to other object</returns>
        public static bool operator ==(GCategory ca0, GCategory ca1) => ca0.TeamId == ca1.TeamId && ca0.Id == ca1.Id;
        /// <summary>
        ...
        public static bool operator !=(GCategory ca0, GCategory ca1) => !(ca0 == ca1);
        /// <summary>
